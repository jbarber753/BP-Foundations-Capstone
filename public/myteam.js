...
displayMyQBs = (stat, sort) => {
    ...
    .then(res1 => {
        if (!stat && !sort){
            axios.get(`/claimedqbs?user=${res1.data.userID}`)
            .then(res2 => {
                if (!res2.data.length){
                    ...
                    for (let i = 0; i < res2.data.length; i++){
                        ...
                        let passingYardsText = document.createTextNode(res2.data[i].passing_yards.toLocaleString());
                        ...
                        let rushingYardsText = document.createTextNode(res2.data[i].rushing_yards.toLocaleString());
            ...
            axios.get(`/claimedqbs?user=${res1.data.userID}&stat=${stat}&sort=${sort}`)
            .then(res2 => {
                if (!res2.data.length){
                    qbTable.style.display = `none`;
                    noQBs.style.display = `inline`;
...
const displayMyRBs = (stat, sort) => {
    ...
    .then(res1 => {
        if (!stat && !sort){
            axios.get(`/claimedrbs?user=${res1.data.userID}`)
            .then(res2 => {
                if (!res2.data.length){
                    ...
                    for (let i = 0; i < res2.data.length; i++){
                        ...
                        let receivingYardsText = document.createTextNode(res2.data[i].receiving_yards.toLocaleString());
            ...
            axios.get(`/claimedrbs?user=${res1.data.userID}&stat=${stat}&sort=${sort}`)
            .then(res2 => {
                for (let i = 0; i < res2.data.length; i++){
                    let newRow = rbTable.insertRow();
                    let buttonCell = newRow.insertCell();
...
const displayMyWRs = (stat, sort) => {
    ...
    .then(res1 => {
        if (!stat && !sort){
            axios.get(`/claimedwrs?user=${res1.data.userID}`)
            .then(res2 => {
                if (!res2.data.length){
            ...
            axios.get(`/claimedwrs?user=${res1.data.userID}&stat=${stat}&sort=${sort}`)
            .then(res2 => {
                for (let i = 0; i < res2.data.length; i++){
                    let newRow = wrTable.insertRow();
                    let buttonCell = newRow.insertCell();
...
const displayMyTEs = (stat, sort) => {
    ...
    .then(res1 => {
        if (!stat && !sort){
            axios.get(`/claimedtes?user=${res1.data.userID}`)
            .then(res2 => {
                if (!res2.data.length){
            ...
            axios.get(`/claimedtes?user=${res1.data.userID}&stat=${stat}&sort=${sort}`)
            .then(res2 => {
                for (let i = 0; i < res2.data.length; i++){
                    let newRow = teTable.insertRow();
                    let buttonCell = newRow.insertCell();
...
const displayMyKs = (stat, sort) => {
    ...
    .then(res1 => {
        if (!stat && !sort){
            axios.get(`/claimedks?user=${res1.data.userID}`)
            .then(res2 => {
                if (!res2.data.length){
            ...
            axios.get(`/claimedks?user=${res1.data.userID}&stat=${stat}&sort=${sort}`)
            .then(res2 => {
                for (let i = 0; i < res2.data.length; i++){
                    let newRow = kTable.insertRow();
                    let buttonCell = newRow.insertCell();
...
const dropPlayer = event => {
    ...
    .then(res => {
        if (event.target.className === `qb-remove-button`){
            axios.delete(`/quarterbacks?player=${event.target.id}`)
            .then(res => alert(res.data))
        }
        else if (event.target.className === `rb-remove-button`){
            axios.delete(`/runningbacks?player=${event.target.id}`)
            .then(res => alert(res.data))
        }
        else if (event.target.className === `wr-remove-button`){
            axios.delete(`/widereceivers?player=${event.target.id}`)
            .then(res => alert(res.data))
        }
        else if (event.target.className === `te-remove-button`){
            axios.delete(`/tightends?player=${event.target.id}`)
            .then(res => alert(res.data))
        }
        else if (event.target.className === `k-remove-button`){
            axios.delete(`/kickers?player=${event.target.id}`)
            .then(res => alert(res.data))
        }
        location.reload();
    })
